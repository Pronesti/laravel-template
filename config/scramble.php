...
use App\Support\Scramble\ProblemResponseExtension;
...
return [
     ...
     */
    /*
     * Enabled: without it the generated OpenAPI document describes no securityScheme at
     * all, so a consumer reading the docs has no way to learn that the auth:sanctum
     * routes want an `Authorization: Bearer <token>` header from POST /api/v1/tokens.
     */
    'security_strategy' => [
